                ...
                <div class="text-center py-10">
                    ...
                    @else
                        <p class="text-red-600 font-bold text-xl">لا يوجد مقررات مسجلة</p>
                         <p class="text-red-600 font-bold text-xl"> سيتم إتاحة الاطلاع على الجدول والتعديل -بعد إجراء عملية التسجيل الآلي- ابتداءً من يوم الثلاثاء 1447/8/15. إلى يوم الخميس 1447/8/17
